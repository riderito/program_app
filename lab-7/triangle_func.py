...
def get_triangle_type(a, b, c):
    # Определяет тип треугольника по длинам его сторон. Параметры: a, b, c (int или float): Длины сторон треугольника.
    # Возвращает: str: Тип треугольника — 'equilateral', 'isosceles', 'nonequilateral'. Исключения:
