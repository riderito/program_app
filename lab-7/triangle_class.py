...
class Triangle:
    ...
    def __init__(self, a, b, c):
        # Конструктор класса. Параметры: a, b, c (int или float): Длины сторон треугольника.
        # Исключения: IncorrectTriangleSides: если данные некорректны.
    ...
    def triangle_type(self):
        # Определяет тип треугольника. Возвращает: str: 'equilateral', 'isosceles' или 'nonequilateral'
    ...
    def perimeter(self):
        # Вычисляет периметр треугольника. Возвращает: float: сумма длин сторон
